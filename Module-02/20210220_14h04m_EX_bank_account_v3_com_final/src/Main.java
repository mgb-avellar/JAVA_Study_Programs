...
public class Main {
    ...
    public static void main(String[] args){
        ...
        // Ilustração do polimorfismo, nada que já não tenhamos visto antes

        BankAccount x = new BankAccount(1020, "Alex", 1000.0);
        BankAccount y = new SavingsAccount(1021, "Maria", 1000.0, 0.01);

        x.withdraw(50.0);
        y.withdraw(50.0);

        System.out.println("x balance: " + x.getBalance() + " and y balance: " + y.getBalance());
    }
}
